...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void CreateNewAccount()
    {
        ...
        {
            Toast.makeText(this, "Veuillez saisir votre adresse électronique...", Toast.LENGTH_SHORT).show();
        }
        ...
        else
        {
            ...
            loadingBar.setMessage("Veuillez patienter pendant que nous créons un nouveau compte pour vous...");
